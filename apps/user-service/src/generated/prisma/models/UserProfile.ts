...
export type UserProfileWhereInput = {
  ...
  sub?: Prisma.StringFilter<"UserProfile"> | string
...
export type UserProfileScalarWhereWithAggregatesInput = {
  ...
  sub?: Prisma.StringWithAggregatesFilter<"UserProfile"> | string
...
export type UserProfileOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"sub" | "email" | "displayName" | "preferences" | "createdAt" | "updatedAt", ExtArgs["result"]["userProfile"]>
...
export interface UserProfileDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `sub`
   * const userProfileWithSubOnly = await prisma.userProfile.findMany({ select: { sub: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many UserProfiles and only return the `sub`
   * const userProfileWithSubOnly = await prisma.userProfile.createManyAndReturn({
   *   select: { sub: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more UserProfiles and only return the `sub`
   * const userProfileWithSubOnly = await prisma.userProfile.updateManyAndReturn({
   *   select: { sub: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface UserProfileFieldRefs {
  readonly sub: Prisma.FieldRef<"UserProfile", 'String'>
